...
exports.PreparationService = void 0;
...
class PreparationService {
     ...
     */
    static async getApplicationPreparation(jobId) {
        ...
        if (latestResumeVer) {
            const data = latestResumeVer.contentJson;
            latestResume = {
                ...data,
            ...
            if (latestResumeVer.atsAnalysis) {
                ...
                latestAtsAnalysis = {
                    ...
                    preferredSkills: ats.preferredSkills,
        ...
        const screeningQuestions = job.screeningQuestions.map((q) => ({
            id: q.id,
            jobId: q.jobId,
            question: q.question,
...
exports.PreparationService = PreparationService;
