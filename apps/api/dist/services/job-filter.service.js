...
exports.JobFilterService = void 0;
class JobFilterService {
     ...
     */
    static evaluatePostingAge(postedAt, referenceTime = new Date()) {
        if (!postedAt) {
            return {
                jobAgeHours: null,
                ageStatus: 'UNKNOWN',
     ...
     */
    static generateDeduplicationKey(company, title, location, canonicalUrl) {
...
exports.JobFilterService = JobFilterService;
