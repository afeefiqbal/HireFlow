...
async function main() {
  ...
  const job1 = await prisma.job.create({
    data: {
      ...
      applicationUrl: 'https://payflow.careers/jobs/senior-laravel-dev',
      canonicalUrl: 'https://payflow.careers/jobs/senior-laravel-dev',
  ...
  const job2 = await prisma.job.create({
    data: {
      ...
      applicationUrl: 'https://northsea.jobs.lever.co/fullstack-laravel-vue',
      canonicalUrl: 'https://northsea.jobs.lever.co/fullstack-laravel-vue',
  ...
  const job3 = await prisma.job.create({
    data: {
      ...
      applicationUrl: 'https://omnicloud.io/careers/senior-node-backend',
      canonicalUrl: 'https://omnicloud.io/careers/senior-node-backend',
  ...
  const job4 = await prisma.job.create({
    data: {
      ...
      applicationUrl: 'https://datametrics.de/jobs/senior-php',
      canonicalUrl: 'https://datametrics.de/jobs/senior-php',
      source: 'Greenhouse Public Board',
    },
  });
  ...
  const job5 = await prisma.job.create({
    data: {
      ...
      applicationUrl: 'https://legacymedia.co.uk/jobs/php-go',
      canonicalUrl: 'https://legacymedia.co.uk/jobs/php-go',
      source: 'EU Remote Tech Feed',
    },
  });
