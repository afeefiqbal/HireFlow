...
// ==========================================
// V6 INTERVIEW INTELLIGENCE CONTRACTS
// ==========================================
...
export interface STARAnswerItem {
  question: string;
  situation: { text: string; attribution: EvidenceAttribution };
  task: { text: string; attribution: EvidenceAttribution };
  action: { text: string; attribution: EvidenceAttribution };
  result: { text: string; attribution: EvidenceAttribution };
...
// ==========================================
// AUTONOMOUS WORKFLOW & AUTO-APPLY CONTRACTS
// ==========================================
...
export interface AutoApplyConfig {
  enabled: boolean;
  autonomousThreshold: number; // default: 85
